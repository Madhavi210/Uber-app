...
export class cabTypeControllerclass {
    getAllCabType = async(req:Request, res:Response) =>{
        try {
            ...
            const response = new apiResponse(200,{totalRecord, totalPages, currentPage: parseInt(req.query.page as string) || 1  ,data}, 'cab type retrieved successfully');
    ...
    getCabTypeById = async(req:Request, res:Response) =>{
        try {
            ...
            const response = new apiResponse(200,data, 'cab type retrieved by id successfully');
            res.status(response.statusCode).json(response);
           } catch (error:any) {
            const errResponse = new apiError(500, 'Internal Server Error', [error.message]);
            res.status(errResponse.statusCode).json(errResponse);
    ...
    createCabType = async(req:Request, res:Response) =>{
        try {
            ...
            const response = new apiResponse(200,data, 'cab type added successfully');
            res.status(response.statusCode).json(response);
        } catch (error:any) {
            const errResponse = new apiError(500, 'Internal Server Error', [error.message]);
            res.status(errResponse.statusCode).json(errResponse);
    ...
    deleteCabTypeById = async(req:Request, res:Response) =>{
        try {
            ...
            const response = new apiResponse(200,data, 'cab type deleted by id successfully');
            res.status(response.statusCode).json(response);
        } catch (error:any) {
            const errResponse = new apiError(500, 'Internal Server Error', [error.message]);
            res.status(errResponse.statusCode).json(errResponse);
    ...
    updateCabTypeById = async(req:Request, res:Response) =>{
        try {
            ...
            const response = new apiResponse(200,data, 'cab type updated by id successfully');
            res.status(response.statusCode).json(response);
        } catch (error:any) {
            const errResponse = new apiError(500, 'Internal Server Error', [error.message]);
            res.status(errResponse.statusCode).json(errResponse);
